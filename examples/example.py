...
def mock_rig():
    return rig.AindBehaviorPirouetteRig(
        ...
        harp_output_expander=abs_rig.HarpOutputExpander(port_name="COM14"),
        harp_white_rabbit=abs_rig.HarpWhiteRabbit(port_name="COM15"),
        onix_commutator=rig.OnixCommutator(
            port_name="COM4", additional_settings=rig.CommutatorSettings(magnetometer_turn_difference_threshold=0.75)
        ),
