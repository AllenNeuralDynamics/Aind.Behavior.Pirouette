...
from aind_behavior_pirouette.rig import AindBehaviorPirouetteRig

sys.path.append(".")
from examples import rig, session  # isort:skip # pylint: disable=wrong-import-position
from tests import JSON_ROOT  # isort:skip # pylint: disable=wrong-import-position

TModel = TypeVar("TModel", bound=Union[AindBehaviorPirouetteRig, AindBehaviorSessionModel])
...
class BonsaiTests(unittest.TestCase):
    def test_deserialization(self):
        ...
        models_to_test = [
            ...
            TestModel(bonsai_property="RigPath", json_root=JSON_ROOT, model=AindBehaviorPirouetteRig),
        ]
