...
namespace AindBehaviorPirouetteDataSchema
{
    ...
    public partial class SpinnakerCamera
    {
        ...
        public SpinnakerCamera()
        {
            ...
            _binning = 1;
            _colorProcessing = AindBehaviorPirouetteDataSchema.SpinnakerCameraColorProcessing.Default;
            _exposure = 1000;
            _gain = 0D;
            _adcBitDepth = AindBehaviorPirouetteDataSchema.SpinnakerCameraAdcBitDepth.Adc8bit;
            _pixelFormat = AindBehaviorPirouetteDataSchema.SpinnakerCameraPixelFormat.Mono8;
